...
class NPY_datasets(Dataset):
    ...
    def __getitem__(self, indx):
        ...
        # # 假设 tezhengxiangliang 是 medsam 函数返回的特征向量
        # tezhengxiangliang = medsam_point(img_path, msk_path,"/tmp/pycharm_project_859/MedSAM-main/work_dir/MedSAM/medsam_vit_b.pth")
        #
        # # 设置保存路径和文件名
        # save_folder = "/tmp/pycharm_project_859/VM-UNet/models/vmunet"
        # save_filename = "tezhengxiangliang.pt"
        #
        # # 确保保存路径存在
        ...
        #
        # # 拼接完整的保存路径
        # save_path = join(save_folder, save_filename)
        #
        # # 保存特征向量到文件
        # torch.save(tezhengxiangliang, save_path)
