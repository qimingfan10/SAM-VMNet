...
parser.add_argument(
    ...
    "--data_path",
    type=str,
    default="/tmp/pycharm_project_859/MedSAM-main/assets/img_demo.png",
...
parser.add_argument(
    ...
    "--seg_path",
    type=str,
    default="/tmp/pycharm_project_859/MedSAM-main/assets/",
...
parser.add_argument(
    ...
    "--checkpoint",
    type=str,
    default="/tmp/pycharm_project_859/MedSAM-main/work_dir/MedSAM/medsam_vit_b.pth",
